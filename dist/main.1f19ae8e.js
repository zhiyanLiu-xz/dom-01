...
var div = dom.creat("<div><span>newDiv</span></div>"); //创建一个节点

console.log(div);
dom.after(test, div);
var div3 = dom.creat('<div id="parent"></div>'); //新建
...
var title = dom.attr(test, "title"); //用dom.attr函数两个参数获取test的title属性

console.log("title: ".concat(title));
dom.text(test, "你好，这是新的文本内容"); //一般用这个是将标签里的内容（文本和标签）全部覆盖，如果想要只覆盖一部分，就用span将其抱起来，给一个特定的id即可，然后针对id操作即可
...
var testDiv = dom.find("#test")[0]; //数组
